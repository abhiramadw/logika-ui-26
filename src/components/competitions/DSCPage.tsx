      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 space-y-24">
        ...
        <section className="space-y-12">
          ...
          <div className="md:hidden mt-10 ml-4 relative border-l-[3px] border-[#b21e13]">
            {dscTimelineRows.flatMap((row, rowIndex) => rowIndex % 2 === 1 ? [...row].reverse() : row).map((item, i) => (
        ...
        <section className="space-y-12 max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col items-center gap-6 pb-2">
            <div className="w-full sm:w-[360px] flex items-center justify-start bg-[#330e00] text-cream rounded-full pl-2 pr-6 py-2 shadow-xl border border-gold/30">
              ...
              <span className="flex-1 text-center font-bold text-base md:text-lg pr-2" style={prizeAmountGradientStyle}>Rp 3.000.000,00 + Piala</span>
            </div>
          ...
          <div className="text-sm md:text-base text-[#73410d] font-medium max-w-3xl mx-auto leading-relaxed pt-6 text-center space-y-2">
            <p>Seluruh peserta yang mengikuti Babak Penyisihan DSC akan mendapatkan e-sertifikat keikutsertaan.</p>
        ...
        <section className="flex flex-col-reverse md:flex-row items-center gap-12 max-w-5xl mx-auto">
          ...
          <div className="w-full md:w-2/3 space-y-6">
            ...
            >
              &quot;DSC LOGIKA UI 2025 benar-benar <i>core memory </i> yang tidak terlupakan! Kami ditantang untuk berpikir <i>out of the box </i> karena case yang diberikan sangat unik dengan data riil yang <i>anti-mainstream</i>, beneran mirip kasus nyata yang tidak langsung siap pakai, jadi ruang untuk bereksperimen dan mengeksplorasi kreativitas tidak terbatas. Selain kompetisinya yang kompetitif, seluruh rangkaian acaranya juga dikemas dengan sangat seru, mulai dari Campus Tour yang asik, <i>talkshow </i> inspiratif, hingga <i>networking </i> dengan peserta lain yang sangat berkesan. Buat kalian para mahasiswa yang ngaku <i>data enthusiast</i>, kompetisi ini adalah panggung terbaik untuk menguji kemampuan kalian, jadi pastikan kalian rebut gelar juara DSC LOGIKA UI selanjutnya!&quot;
            </blockquote>
          </div>
        </section>
