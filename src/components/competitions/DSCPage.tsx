      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 space-y-24">
        ...
        <section className="flex flex-col md:flex-row items-center gap-12">
          <div className="flex-1 space-y-6">
            <h1 className="text-4xl md:text-5xl font-black leading-tight uppercase" style={gradientStyle}>
              Data Science <br className="hidden md:block" />
              Competition (DSC)
            </h1>
        ...
        <section className="space-y-12 max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col items-center gap-6">
            <div className="flex items-center bg-[#330e00] text-cream rounded-full pl-2 pr-6 py-2 shadow-xl border border-gold/30">
              ...
              <span className="ml-4 font-bold text-lg md:text-xl text-gold">Rp 3.000.000,00 + Piala</span>
            </div>
            <div className="flex flex-col md:flex-row gap-6">
              <div className="flex items-center bg-[#330e00] text-cream rounded-full pl-2 pr-6 py-2 shadow-xl border border-gold/30">
                ...
                <span className="ml-4 font-bold text-base md:text-lg text-cream-light">Rp 2.000.000,00 + Piala</span>
              </div>
              <div className="flex items-center bg-[#330e00] text-cream rounded-full pl-2 pr-6 py-2 shadow-xl border border-gold/30">
        ...
        <section className="flex flex-col md:flex-row items-center gap-12 max-w-5xl mx-auto">
          ...
          <div className="w-full md:w-2/3 space-y-6">
            ...
            <div>
              <p className="font-bold text-[#330e00]">Geutanyoe</p>
              <p className="text-sm text-[#73410d]">Universitas Syiah Kuala</p>
              <p className="text-sm text-[#73410d] italic">Juara 1 DSC LOGIKA UI 2025</p>
            </div>
          </div>
        </section>
