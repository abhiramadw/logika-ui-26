      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 space-y-24">
        ...
        <section className="flex flex-col md:flex-row items-center gap-12">
          <div className="flex-1 space-y-6">
            ...
            <div className="flex flex-wrap gap-4 pt-2">
              <Link href="https://docs.google.com/forms/d/e/1FAIpQLSec0der9_7pLFs7WK5Cx_f38egqY_TyWMagM5UT2x_bEQNpJw/viewform?usp=publish-editor" target="_blank" rel="noopener noreferrer" style={btnStyle}>
                REGISTER NOW <Plus size={14} />
              </Link>
              <Link href="https://drive.google.com/drive/folders/1oDGmQ2zq7BLXdfhEc0NCNtcQOq22bAoO" target="_blank" rel="noopener noreferrer" style={btnStyle}>
        ...
        <section className="space-y-12">
          ...
          <div className="md:hidden mt-10 ml-4 relative border-l-[3px] border-[#b21e13]">
            {uecTimelineRows.flatMap((row, rowIndex) => rowIndex % 2 === 1 ? [...row].reverse() : row).map((item, i) => (
        ...
        <section className="space-y-12 max-w-4xl mx-auto text-center">
          ...
          <div className="text-sm md:text-base text-[#73410d] font-medium max-w-3xl mx-auto leading-relaxed pt-6 text-center space-y-2">
            <p>Seluruh peserta yang mengikuti Babak Penyisihan UEC akan mendapatkan e-sertifikat keikutsertaan.</p>
