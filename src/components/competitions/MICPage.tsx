...
export default function MICPage() {
  ...
  const faqs = [
    { q: "Siapa saja yang boleh mendaftar MIC?", a: "Siswa SMA/sederajat di seluruh Indonesia." },
    { q: "Materi apa saja yang diujikan pada MIC?", a: "Materi mencakup Aljabar, Geometri, Kombinatorika, dan Teori Bilangan sesuai standar olimpiade." },
    { q: "Apakah peserta yang telah menang LOGIKA UI boleh ikut lagi tahun ini?", a: "Tentu saja boleh, selama masih memenuhi persyaratan sebagai peserta." },
    { q: "Apakah peserta bisa mendaftar MIC bersamaan dengan lomba lain?", a: "Bisa, asalkan jadwal pelaksanaannya tidak bentrok dengan lomba lain yang diikuti." },
    { q: "Apakah MIC diselenggarakan secara online atau offline?", a: "Babak penyisihan diselenggarakan secara online, sedangkan Semifinal dan Final diselenggarakan secara offline di Universitas Indonesia." },
    { q: "Perangkat apa saja yang dibutuhkan untuk babak penyisihan?", a: "Laptop atau komputer dengan koneksi internet yang stabil serta webcam untuk pengawasan." },
  ];
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 space-y-24">
          ...
          <div className="flex-1 space-y-6">
            ...
            <div className="flex flex-wrap gap-4 pt-2">
              <Link href="#" className="inline-flex items-center gap-2 bg-[#330e00] text-gold px-6 py-2.5 rounded-full text-sm font-bold tracking-wide hover:bg-[#73410d] transition-colors shadow-lg">
                SILABUS DAN SOAL
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-3 3m0 0l-3-3m3 3V4" /></svg>
              </Link>
              <Link href="#" className="inline-flex items-center gap-2 bg-[#330e00] text-gold px-6 py-2.5 rounded-full text-sm font-bold tracking-wide hover:bg-[#73410d] transition-colors shadow-lg">
                SEE GUIDEBOOK
        ...
        <section className="flex flex-col md:flex-row items-center gap-12 max-w-5xl mx-auto">
          ...
          <div className="w-full md:w-2/3 space-y-6">
            ...
            <div>
              <p className="font-bold text-[#330e00]">Ahsan Farras Suwarno</p>
