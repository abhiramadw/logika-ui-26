        ...
        <section className="space-y-12 max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col items-center gap-6 pb-2">
            <div className="flex items-center bg-[#330e00] text-cream rounded-full pl-2 pr-6 py-2 shadow-xl border border-gold/30">
              ...
              <span className="ml-4 font-bold text-lg md:text-xl" style={prizeAmountGradientStyle}>Rp 6.000.000,00 + Piala</span>
            </div>
            <div className="flex flex-col md:flex-row gap-6">
              <div className="flex items-center bg-[#330e00] text-cream rounded-full pl-2 pr-6 py-2 shadow-xl border border-gold/30">
                ...
                <span className="ml-4 font-bold text-base md:text-lg" style={prizeAmountGradientStyle}>Rp 4.500.000,00 + Piala</span>
              </div>
              <div className="flex items-center bg-[#330e00] text-cream rounded-full pl-2 pr-6 py-2 shadow-xl border border-gold/30">
                <div className="relative">
                ...
                <span className="ml-4 font-bold text-base md:text-lg" style={prizeAmountGradientStyle}>Rp 3.000.000,00 + Piala</span>
              </div>
            </div>
          </div>
