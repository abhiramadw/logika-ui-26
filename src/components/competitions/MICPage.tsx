...
export default function MICPage() {
  ...
  const faqs = [
    ...
    { q: "Materi apa saja yang diujikan pada MIC?", a: "Materi MIC mengikuti standar olimpiade matematika tingkat SMA, yang umumnya meliputi Aljabar, Kombinatorika, Geometri, dan Teori Bilangan. Cakupan lengkapnya dapat dilihat pada guidebook yang disediakan." },
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 space-y-24">
        ...
        <section className="space-y-12">
          ...
          <div className="md:hidden mt-10 ml-4 relative border-l-[3px] border-[#b21e13]">
            {micTimelineRows.flatMap((row, rowIndex) => rowIndex % 2 === 1 ? [...row].reverse() : row).map((item, i) => (
        ...
        <section className="space-y-12 max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col items-center gap-6 pb-2">
            <div className="w-full sm:w-[360px] flex items-center justify-start bg-[#330e00] text-cream rounded-full pl-2 pr-6 py-2 shadow-xl border border-gold/30">
              ...
              <span className="flex-1 text-center font-bold text-base md:text-lg pr-2" style={prizeAmountGradientStyle}>Rp 3.500.000,00 + Piala</span>
            </div>
            <div className="flex flex-col md:flex-row gap-6 w-full justify-center items-center">
              <div className="w-full sm:w-[360px] flex items-center justify-start bg-[#330e00] text-cream rounded-full pl-2 pr-6 py-2 shadow-xl border border-gold/30">
                ...
                <span className="flex-1 text-center font-bold text-base md:text-lg pr-2" style={prizeAmountGradientStyle}>Rp 2.500.000,00 + Piala</span>
              </div>
              <div className="w-full sm:w-[360px] flex items-center justify-start bg-[#330e00] text-cream rounded-full pl-2 pr-6 py-2 shadow-xl border border-gold/30">
                <div className="relative shrink-0">
          ...
          <div className="text-sm md:text-base text-[#73410d] font-medium max-w-3xl mx-auto leading-relaxed pt-6 text-center space-y-2">
            <p>Seluruh peserta yang mengikuti Babak Penyisihan MIC akan mendapatkan e-sertifikat keikutsertaan.</p>
        ...
        <section className="flex flex-col-reverse md:flex-row items-start gap-12 max-w-5xl mx-auto">
          <div className="w-full md:w-1/3 flex flex-col items-center gap-4">
            <div className="w-full aspect-[1331/1400] relative rounded-2xl overflow-hidden shadow-2xl border-4 border-gold/30">
              <Image
            ...
            <div className="text-center">
              <p className="font-bold text-lg text-[#330e00]">Abian Farras Suwarso</p>
              <p className="text-base text-[#73410d]">MAN Insan Cendekia Serpong</p>
              <p className="text-base text-[#73410d]">Finalis MIC LOGIKA UI 2025</p>
            </div>
          </div>
          <div className="w-full md:w-2/3 space-y-6">
            <h2 className="text-4xl md:text-5xl font-bold font-serif" style={titleGradientStyle}>
